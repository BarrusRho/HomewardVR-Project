...
Shader "Water2_Shader"
{
	...
	SubShader
	{
		...
		{
			half2 panner10 = ( 1.0 * _Time.y * float2( 0.2,-0.2 ) + i.uv_texcoord);
			half2 panner11 = ( 1.0 * _Time.y * float2( 0.2,-0.2 ) + i.uv_texcoord);
			...
			half2 panner42 = ( 1.0 * _Time.y * float2( -0.01,0.01 ) + uv0_FoamTextureMap);
...
/*ASEBEGIN
Version=17500
-25;880;1918;1016;4445.334;295.1878;2.912305;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;37;-2208,640;Inherit;True;Property;_FoamDepth;Foam Depth;8;0;Create;True;0;0;False;0;0;0.9;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-1968,16;Inherit;True;Property;_WaterDepth;Water Depth;5;0;Create;True;0;0;False;0;0;0.9;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;10;-4176,304;Inherit;True;3;0;FLOAT2;0,0;False;2;FLOAT2;0.2,-0.2;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.AbsOpNode;4;-2144,-48;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;11;-4176,640;Inherit;True;3;0;FLOAT2;0,0;False;2;FLOAT2;0.2,-0.2;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;12;-3792,640;Inherit;True;Property;_WaterNormalMap;Water Normal Map;2;0;Create;True;0;0;False;0;-1;None;dd2fd2df93418444c8e280f1d34deeb5;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;39;-1984,864;Inherit;True;Property;_FoamFalloff;Foam Falloff;9;0;Create;True;0;0;False;0;0;-5.89;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-1760,16;Inherit;True;Property;_WaterFalloff;Water Falloff;6;0;Create;True;0;0;False;0;0;-11.92;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PannerNode;42;-1744,1120;Inherit;True;3;0;FLOAT2;0,0;False;2;FLOAT2;-0.01,0.01;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;43;-1408,1120;Inherit;True;Property;_FoamTextureMap;Foam Texture Map;10;0;Create;True;0;0;False;0;-1;None;d01457b88b1c5174ea4235d140b5fab8;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;6;-1600,-448;Inherit;False;Property;_DeepColour;Deep Colour;0;0;Create;True;0;0;False;0;0,0,0,0;0.02352941,0.4078426,0.6352941,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-640,336;Inherit;False;Property;_FoamSpecular;Foam Specular;12;0;Create;True;0;0;False;0;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;53;-480,736;Inherit;False;Property;_FoamSmoothness;Foam Smoothness;14;0;Create;True;0;0;False;0;0;0.2;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=C723B986F303FB304A084AF24D511FF157DA1F95