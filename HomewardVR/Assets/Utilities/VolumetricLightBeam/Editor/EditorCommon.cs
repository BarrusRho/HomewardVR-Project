...
namespace VLB
{
    public class EditorCommon : Editor
    {
        ...
        {
            Debug.Assert(m_CurrentFoldableHeader == null, string.Format("Trying to call HeaderFoldableBegin({0}) while a previous one '{1}' is not closed", label.text, m_CurrentFoldableHeader));
